...
import com.fasting.tracker.databinding.FragmentMainPlanBinding
import com.fasting.tracker.ui.adapter.PlanAdapter
import com.fasting.tracker.viewmodels.MainPlanViewModel
import com.zhuinden.fragmentviewbindingdelegatekt.viewBinding
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class MainPlanFragment : Fragment(R.layout.fragment_main_plan) {

    private val viewModel: MainPlanViewModel by viewModels()
    private val binding: FragmentMainPlanBinding by viewBinding(FragmentMainPlanBinding::bind)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter.differ.submitList(create24HoursList())

    }
    fun create24HoursList():List<PlansModel>{
