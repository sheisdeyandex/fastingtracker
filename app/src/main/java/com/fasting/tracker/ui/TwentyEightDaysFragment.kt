...
import com.fasting.tracker.viewmodels.TwentyEightDaysViewModel
import com.zhuinden.fragmentviewbindingdelegatekt.viewBinding
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class TwentyEightDaysFragment : Fragment(R.layout.fragment_twenty_eight_days) {
    private val viewModel: TwentyEightDaysViewModel by viewModels()
    private val binding: FragmentTwentyEightDaysBinding by viewBinding(FragmentTwentyEightDaysBinding::bind)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter.differ.submitList(create28DaysList())

    }
    fun create28DaysList():List<PlansModel>{
